...
const HowItWorks = () => {
  ...
  return (
    <section className="py-16 md:py-20 px-4 bg-gradient-to-b from-[#F5FAFF] dark:from-gray-900 to-white dark:to-gray-800">
      <div className="w-11/12 mx-auto">
        <div className="max-w-6xl mx-auto text-center">
        {/* Section Header */}
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#27548A] dark:text-blue-400 mb-6">
          How It Works
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100 dark:border-gray-700 hover:border-[#27548A]/30 dark:hover:border-blue-500/30 group"
            >
              {/* Step Number */}
              ...
              {/* Content */}
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 group-hover:text-[#27548A] dark:group-hover:text-blue-400 transition-colors">
                {step.title}
              </h3>
